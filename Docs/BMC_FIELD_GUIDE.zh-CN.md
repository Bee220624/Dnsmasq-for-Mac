...
2026-09-20 已在本机完成首次系统 Helper 批准和真实 XPC 身份握手，返回版本 0.1.1、协议 1、`euid=0`。当前没有接入 BMC/DHCP 客户端，因此真实 DHCP 获租约、浏览器连通 BMC、物理拔线后的完整系统清理尚未完成。不要把自动化测试或 Helper 握手通过理解为实机端到端验收已完成。
