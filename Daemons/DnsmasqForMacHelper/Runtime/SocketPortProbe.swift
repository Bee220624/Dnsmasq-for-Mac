...
///
/// The specification requires this. Listing what is using a port — through `lsof`, `netstat`, or
...
///
/// The specification permits `lsof` strictly for diagnostics: its arguments are built from code
