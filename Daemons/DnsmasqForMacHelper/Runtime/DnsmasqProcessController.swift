    ...
    func terminate(
        ...
        case .identityMismatch(let actualPath):
            ...
            throw ServiceFailure(
                ...
                message: "The process Dnsmasq for Mac started is no longer running, and its process "
                    + "ID now belongs to something else.",
                recoverySuggestion:
                    "Dnsmasq for Mac has left it alone. Choose Repair to clean up what remains.",
