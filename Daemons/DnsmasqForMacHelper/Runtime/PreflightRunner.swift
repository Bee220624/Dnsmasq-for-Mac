    ...
    func run(
        ...
        if let existingSession {
            fail(.helperInstalled, PreflightIssue(
                ...
                message: "Dnsmasq for Mac is already serving on "
    ...
    private func testGeneratedConfiguration(
        ...
        do {
            ...
            return (PreflightIssue(
                ...
                recoverySuggestion: "Try again. If it keeps happening, reinstall Dnsmasq for Mac."
            ), "\(error)")
        }
        ...
        guard result.succeeded else {
            return (PreflightIssue(
                ...
                recoverySuggestion: "This is a Dnsmasq for Mac problem. Please report it with the details below."
            ), output)
        }
        ...
        for port in required {
            ...
            case .indeterminate(let reason):
                ...
                issues.append(PreflightIssue(
                    ...
                    message: "Dnsmasq for Mac could not confirm that "
