...
final class HelperRequestHandler: NSObject, DnsmasqForMacHelperProtocol, @unchecked Sendable {
    ...
    private func replyNotImplemented(
        ...
        let failure = ServiceFailure(
            ...
            recoverySuggestion: "Update Dnsmasq for Mac to a build where this operation is available.",
