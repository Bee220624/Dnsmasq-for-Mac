...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let logger = Logger(subsystem: "com.bee.dnsmasqformac", category: "app-delegate")
    ...
    func applicationShouldTerminate(
        ...
        let alert = NSAlert()
        alert.messageText = String(localized: "Dnsmasq for Mac services are still running.")
