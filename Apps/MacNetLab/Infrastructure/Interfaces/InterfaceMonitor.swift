...
final class InterfaceMonitor {
    ...
    private let logger = Logger(subsystem: "com.bee.macnetlab", category: "interfaces")
    ...
    private static let lastSelectedDefaultsKey = "com.bee.macnetlab.lastSelectedInterface"
