...
actor ProfileStore {
    ...
    private let logger = Logger(subsystem: "com.bee.macnetlab", category: "profiles")
    ...
    /// Default location: `~/Library/Application Support/com.bee.macnetlab/` (ticket §20.1).
    static func defaultDirectory(
        appSupportDirectoryName: String = "com.bee.macnetlab"
    ) -> URL {
